...
import { LicenseExportResult } from "./license-export-result"
...
export const LicenseCreateDialog = ({
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            const result = await axios.post(route('licenses.create'), _values);
            if (result.status === 200) {
                if (_values.is_export) {
                    const createdLicenses = result.data.created_licenses;
                    setCreatedLicenses(createdLicenses);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <DialogContent>
                ...
                {!showExportResult ? (
                    ...
                    <LicenseExportResult licenses={createdLicenses} />
                )}
